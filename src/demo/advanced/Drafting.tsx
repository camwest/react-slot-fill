...
export default class Drafting extends React.Component<any, any> {
  ...
  render() {
    ...
    //   ? <Workspace.Panel title="Drafting">{snappingNotice}</Workspace.Panel>
    //   : null;
      ...
      <div>
        ...
        <Settings.Group label="Drafting">
          <Settings.Checkbox
            ...
            onChange={this.handleEnableSnapping}
          />
        </Settings.Group>*/}
      </div>
    );
